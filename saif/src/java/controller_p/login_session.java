 ...
 * @author r4ad
 */
@WebFilter(filterName = "login_session", urlPatterns = {"/*"})
public class login_session implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("login_session:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("login_session:DoAfterProcessing");
        }
...
"    <body>";
    ...
    String redirect="account.jsp?a=login";
     ...
     redirect="account.jsp?a=login_apply_offer";
     
     }
     else if(type.equals("login_apply_travel"))   {
     redirect="account.jsp?a=login_apply_travel";
     
     }
      else if(type.equals("login_apply_hotel"))   {
     redirect="account.jsp?a=login_apply_hotel";
        ...
        String password=request.getParameter("password");
                       ...
                       if(v.validate_email(email)){
                             if(v.validate_password(password)){ 
                           ...
                           out.print("sorry invalid email syntax");
                           rd.include(request, response);
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("login_session:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("login_session(");
